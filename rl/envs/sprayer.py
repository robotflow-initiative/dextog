...
class SprayerCallback(BaseCallback):
    """
...
class RFUVecEnv(DummyVecEnv):
    def __init__(
        ...
        self.rfu = RFUniverseBaseEnv(
            executable_file=osp.join(osp.split(__file__)[0], "../assets/envs/sprayer/sprayer_env.x86_64"),
...
def SprayerVecEnv(num_envs, proc_id=0, shared_data=None, **kwargs):
    import os
